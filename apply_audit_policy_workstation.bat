...
:: Аудит службы проверки подлинности Kerberos -- Нет аудита
auditpol /set /subcategory:{0CCE9242-69AE-11D9-BED3-505054503030} /success:disable /failure:disable

:: Аудит операций с билетами службы Kerberos -- Нет аудита
...
:: Аудит управления учетными записями компьютеров -- Нет аудита
auditpol /set /subcategory:{0CCE9236-69AE-11D9-BED3-505054503030} /success:disable /failure:disable

:: Аудит управления группами распространения -- Нет аудита
...
:: Аудит подробной репликации службы каталогов -- Нет аудита
